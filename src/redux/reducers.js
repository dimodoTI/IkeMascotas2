...
import { reducer as atencionesReducer } from "./atenciones/reducer";
import { reducer as autorizacionReducer } from "./autorizacion/reducer";
import { reducer as calendarioReducer } from "./calendario/reducer";
import { reducer as clienteReducer } from "./cliente/reducer";
import { reducer as configuracionReducer } from "./configuracion/reducer";
import { reducer as mascotasReducer } from "./mascotas/reducer";
import { reducer as mascotasTipoReducer } from "./mascotastipo/reducer";
import { reducer as mascotasvacunasReducer } from "./mascotasvacunas/reducer";
import { reducer as publicacionReducer } from "./publicacion/reducer";
import { reducer as puestosReducer } from "./puestos/reducer";
import { reducer as razasReducer } from "./razas/reducer";
import { reducer as reservasReducer } from "./reservas/reducer";
import { reducer as tramosReducer } from "./tramos/reducer";
import { reducer as turnosdisponiblesReducer } from "./turnosdisponibles/reducer";
import { reducer as usuarioReducer } from "./usuario/reducer";
import { reducer as vacunasReducer } from "./vacunas/reducer";
import { reducer as fotosReducer } from "./fotos/reducer";
import { reducer as adjuntosReducer } from "./adjuntos/reducer";
import { reducer as chatReducer } from "./chat/reducer";
import { reducer as notificacionesReducer } from "./notificacion/reducer";
