...
export const idiomas = {
    ES: {
        ...
        listaReserva: {
            verDetalle: "Ver detalle",
            agendarReserva: "Agendar Reserva",
        },
        consultaMascota: {
            titulo: "Agendá una consulta",
            subTitulo: "Completá los datos de tu mascota y sus síntomas.",
        ...
        cobertura: {
            warningTitulo: ["Estado de cuenta"],
            warningCuerpo: ["Para acceder a esta opcion, la cuenta debe estar al día. Para verificar tu estado puedes llamar a Iké Asistencias."],
        },
    },
};
