...
} from "./calendario/middleware"
import {
  middleware as configuracion
} from "./configuracion/middleware"
import {
  middleware as mascotas
} from "./mascotas/middleware"
import {
  middleware as mascotastipo
} from "./mascotastipo/middleware"
import {
  middleware as mascotasvacunas
} from "./mascotasvacunas/middleware"
import {
  middleware as publicacion
} from "./publicacion/middleware"
import {
  middleware as puestos
} from "./puestos/middleware"
import {
  middleware as razas
} from "./razas/middleware"
import {
  middleware as reservas
} from "./reservas/middleware"
import {
  middleware as tramos
} from "./tramos/middleware"
import {
  middleware as turnosdisponibles
} from "./turnosdisponibles/middleware"
import {
  middleware as usuario
} from "./usuario/middleware"
import {
