...
import { LOGIN, RECUPERO, RENOVACION, LOGON, UPDATE_PROFILE, LOGIN_SUCCESS, RECUPERO_SUCCESS, RENOVACION_SUCCESS, LOGON_SUCCESS, UPDATE_PROFILE_SUCCESS, LOGIN_ERROR, RECUPERO_ERROR, RENOVACION_ERROR, LOGON_ERROR, UPDATE_PROFILE_ERROR } from "./actions";
...
import { getCantidad as getMascotasVacunas } from "../mascotasvacunas/actions";

import { get as getReservas, reservaCantidad } from "../reservas/actions";

import { showSpinner, hideSpinner, showError, showWarning, selectMenu } from "../ui/actions";

import { goTo } from "../routing/actions";

import { get as getChat, recibirMensaje, sinContestar, setCampana } from "../chat/actions";
import { getNotificacionChatPendientes } from "../notificacion/actions";
    ...
    (action) => {
        ...
        if (action.type === LOGIN_SUCCESS) {
            if (action.payload.receive.message) {
                ...
                let pantalla = getState().screen.name;
                if (pantalla) {
