...
import { CHAT, CONSULTA, VIDEO, ARCHIVO } from "../../../assets/icons/icons";

import { edit as editReservas, reservar, enAtencion as getEnAtencion, agendarReserva } from "../../redux/reservas/actions";
	...
	render() {
		return html`
			<div id="cuerpo">
				...
				<div id="div-Titulo-02">${idiomas[this.idioma].misConsultas.titulo02}</div>
				<div style="display:grid">
					<pantalla-listareserva></pantalla-listareserva>
				</div>
			</div>
