...
import { MASCOTA } from "../../../assets/icons/icons";

import { edit as editMascotas, get as getMascotas, getEdit as getEditMascota, getEdit } from "../../redux/mascotas/actions";
    ...
    render() {
        return html`
            ...
            <div id="cuerpo">
                ${this.items.map(
                    (dato) => html`
                        <div id="cmhDivEtiqueta" .item=${dato} @click="${this.editar}" style="cursor:pointer">
                            <div id="cmhDivImagen" style="background-position:center;background-image:url(${dato.Foto});"></div>
