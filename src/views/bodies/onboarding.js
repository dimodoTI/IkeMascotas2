		...
		if (this.lineas.length > 0) {
			return html`
				...
				<div id="cuerpo">
					...
					<button id="btn-siguiente" btn1 @click=${this.clickBoton1}>${idiomas[this.idioma].onboarding.btn1}</button>
					<button id="btn-cuenta" btn2 @click=${this.clickBoton2}>${idiomas[this.idioma].onboarding.btn2}</button>
				</div>
			`;
		}
	}
