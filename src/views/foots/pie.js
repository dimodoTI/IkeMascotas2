...
import { get as getReservas } from "../../redux/reservas/actions";
import { get as getMascotas, getCombo } from "../../redux/mascotas/actions";
...
export class pieComponente extends connect(store, MEDIA_CHANGE, SCREEN, SELECTMENU)(LitElement) {
    ...
    render() {
        return html`
            <div id="pieCabecera"></div>
            <div id="pieMenu">
                <div id="img-home" select=${this.opcion == "uno" ? "SI" : "NO"} @click="${this.clickBoton1}" class="img">${HOME}</div>
                <div id="img-mascota" select=${this.opcion == "dos" ? "SI" : "NO"} @click="${this.clickBoton2}" class="img">${MASCOTA}</div>
                <div id="img-consulta" select=${this.opcion == "tres" ? "SI" : "NO"} @click="${this.clickBoton3}" class="img">${CONSULTA}</div>
                <div id="img-vacuna" select=${this.opcion == "cuatro" ? "SI" : "NO"} @click="${this.clickBoton4}" class="img">${VACUNA}</div>
                <div id="lbl-home" select=${this.opcion == "uno" ? "SI" : "NO"} @click="${this.clickBoton1}" class="lbl">${idiomas[this.idioma].pie.inicio}</div>
                <div id="lbl-mascota" select=${this.opcion == "dos" ? "SI" : "NO"} @click="${this.clickBoton2}" class="lbl">${idiomas[this.idioma].pie.mascota}</div>
                <div id="lbl-consulta" select=${this.opcion == "tre" ? "SI" : "NO"} @click="${this.clickBoton3}" class="lbl">${idiomas[this.idioma].pie.consulta}</div>
                <div id="lbl-vacuna" select=${this.opcion == "cuatro" ? "SI" : "NO"} @click="${this.clickBoton4}" class="lbl">${idiomas[this.idioma].pie.vacuna}</div>
            </div>
            <div id="divAyudaPie">
