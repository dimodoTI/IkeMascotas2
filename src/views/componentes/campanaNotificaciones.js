...
import { CAMPANA, CAMPANA_CONMARCA } from "../../../assets/icons/icons";

import { sinContestar } from "../../redux/chat/actions";

import { goNext, goPrev, goTo } from "../../redux/routing/actions";

import { getNotificacionChatPendientes } from "../../redux/notificacion/actions";
...
export class campanaNotificaciones extends connect(store, SET_CAMPANA, GET_NOTIFICACION_CHAT_PENDIENTES_SUCCESS)(LitElement) {
    ...
    render() {
        return html` <div id="campana" @click=${this.notificaciones}>${this.mensaje ? CAMPANA_CONMARCA : CAMPANA}</div> `;
    }
